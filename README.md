...
| `scan-results/` | Generated by the scripts. One dated file per day (`hn-scan-2026-08-18.md`, etc), never overwrites an older day, so it's a running history. Not gitignored, keep or commit them if you want the history in git |
