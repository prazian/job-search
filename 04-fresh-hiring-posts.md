...
**The honest number: 4 usable, not 15.** Hacker News is the only one of the target platforms (Reddit, Twitter/X, LinkedIn, Discord, Telegram) that has a public, scriptable API. I tested Reddit directly and it hard-blocks non-browser requests (403 "blocked due to network policy"); Twitter/X, LinkedIn, and Discord all require an authenticated session I don't have. Rather than pad this out with 10 more that I couldn't actually verify, here are the leads that are **real, dated, and independently checkable right now**. Click any link below. (A 5th, Flywheel Motion, was here too until it got pulled and blocklisted, see [07-companies-to-avoid.md](07-companies-to-avoid.md).)
...
## The 4 usable leads (plus 1 blocklisted)
...
### 🚫 Flywheel Motion, blocklisted, do not pitch
**[Post](https://news.ycombinator.com/item?id=49156702)** · Was listed here as a "Sr Agentic Engineer" contract lead. Pulled after direct report: they frame real production work as a "40 minute task" and expect it done unpaid, a classic unpaid-labor extraction pattern, not a real engagement. Full writeup in [07-companies-to-avoid.md](07-companies-to-avoid.md). `scripts/hn_scan.py` now flags this one automatically if it shows up again in a future thread.

### 3. Arcforma AI, AI Engineer (contract track), 🟡 confirm which kind of "US only" before pitching
...
### 4. Early-stage health & wellness startup (doubling.io), 🔴 skip, this one's a real blocker
